...
### Изменение в Dendrite
#### Новые эндпоинты
| Метод  | Путь                             | Описание                                                           |
|--------|----------------------------------|--------------------------------------------------------------------|
| GET    | /fstick/api/v1/chats/{chat_id}/members/{user_id}    | Получение информации о пользователе в чате |
| POST   | /fstick/api/v1/chats/{chat_id}/messages             | Отправка сообщение от лица плагина         |

...
export default defineConfig({
    build: {
        // Do not wipe the dist folder when starting in watch mode so that
        // webpack-dev-server (which starts in parallel) can still resolve
        // the previously built CSS/JS while vite is doing its first rebuild.
        emptyOutDir: false,
        lib: {
